...
use App\Models\Modelmahasiswa as ModelsModelmahasiswa;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\Models\Modelmahasiswa;
// use app\Controllers\Modelmahasiswa;
...
class Mahasiswa extends ResourceController
{
    ...
    {
       $modelMhs = new ModelsModelmahasiswa();
    ...
    {
        $model = new ModelsModelmahasiswa();
        $data = [
